...
export function HeroPropertyCarousel({ properties }: HeroPropertyCarouselProps) {
  ...
  return (
    ...
    >
      ...
      {/* Mobile overlay: balanced black layer + vertical gradient + lateral gradient for optimal readability */}
      <div className="absolute inset-0 bg-black/45 md:hidden z-[1]" />
      <div className="absolute inset-0 bg-gradient-to-t from-deep via-deep/70 to-transparent md:hidden z-[2]" />
      <div className="absolute inset-0 bg-gradient-to-r from-deep/60 via-deep/20 to-transparent md:hidden z-[2]" />
